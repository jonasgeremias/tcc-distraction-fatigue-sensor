   ...
   #define LED_STATUS_BASE_TEMPO_MS 25
...
static volatile modo_led_t modo_led = LED_STATUS_DESLIGADO;
...
static void controle_led_status(modo_led_t modo_atual) {
   static bool s_led = 0;
   static modo_led_t led_status_anterior = LED_STATUS_DESLIGADO;
...
static void task_led_status(void* pv) {
   ...
   modo_led_t modo_temp = LED_STATUS_DESLIGADO;
...
void modo_led_status(modo_led_t modo) {
